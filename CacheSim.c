...
int main(int argc, char *argv[])
{
	...
	printf("HIT: %7d MISS: %7d Miss Ratio: %7f\n", HIT, MISS, (double)MISS / ((double)HIT + (double)MISS));
	printf("Cache Size: %7d Block Size: %7d Index Size: %7d\n", CACHE_SIZE, BLOCK_SIZE, INDEX_SIZE);
	printf("Index Length: %2d Tag Length: %2d Offset Size: %2d\n", INDEXLEN, TAGLEN, OFFSETLEN);
}